...
export function MenuItemCard({ item, onClick }: Props) {
  ...
  return (
    <button
      ...
      disabled={disabled}
      className={cn(
        'group relative flex flex-col text-left rounded-lg border border-neutral-200 dark:border-neutral-800',
        'bg-white dark:bg-neutral-900 hover:bg-neutral-100 dark:bg-neutral-800 hover:border-neutral-300 dark:border-neutral-700 transition-colors',
        'min-h-[120px] p-3',
        'focus:outline-none focus-visible:ring-2 focus-visible:ring-red-500/60',
        disabled && 'opacity-50 cursor-not-allowed hover:bg-white dark:bg-neutral-900 hover:border-neutral-200 dark:border-neutral-800',
      )}
    >
