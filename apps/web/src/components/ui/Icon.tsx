...
export type IconName =
  | 'cart' | 'history' | 'truck' | 'calendar' | 'clock' | 'bell' | 'trash'
...
const PATHS: Record<IconName, React.ReactNode> = {
  ...
  channel: <><path d="M22 8v6a4 4 0 0 1-4 4H6a4 4 0 0 1-4-4V8a4 4 0 0 1 4-4h8"/><path d="M18 2v4M14 2v4M10 2v4M6 2v4"/><circle cx="18" cy="14" r="2"/></>,
  branch: <><line x1="6" y1="3" x2="6" y2="15"/><circle cx="18" cy="6" r="3"/><circle cx="6" cy="18" r="3"/><path d="M18 9a9 9 0 0 1-9 9"/></>,
  kiosk: <><rect x="3" y="3" width="18" height="14" rx="2"/><line x1="8" y1="21" x2="16" y2="21"/><line x1="12" y1="17" x2="12" y2="21"/></>,
  receipt: <><path d="M14 2H6a2 2 0 0 0-2 2v16l4-2 4 2 4-2 2 2V8z"/><polyline points="14 2 14 8 20 8"/><line x1="9" y1="13" x2="15" y2="13"/><line x1="9" y1="17" x2="15" y2="17"/></>,
  ...
  // Sprint 20 — sidebar collapse toggle. Open = sidebar collapsed (show
  ...
  'maximize': <><rect x="3" y="3" width="18" height="18" rx="2"/><polyline points="9 3 9 21 21 21"/></>,
  'minimize': <><rect x="3" y="3" width="18" height="18" rx="2"/><polyline points="9 3 9 21 3 21"/></>,
};
