...
test.describe('POS UI Testing', () => {
  ...
  test('Login Flow', async ({ page }) => {
    await page.goto('https://pos.akhairi.com');
  ...
  test('Shift Management', async ({ page }) => {
    await page.goto('https://pos.akhairi.com/shifts');
